...
const ConfigRestaurante = React.lazy(() => import('./views/restaurante/configRestaurante'));

const routes = [
  { path: '/', exact: true, name: 'Home' },
  { path: '/configuracaoRestaurante', exact: true, name: 'Configuração', component: ConfigRestaurante },
